          ...
          <div className="w-full mx-auto overflow-auto max-h-600">
            <table className="w-full border-collapse border mt-5">
              <thead className="font-tableH bg-[#0066AD] text-white sticky top-0">
                <tr className="bg-[#0066AD] text-white">
                  <th className="w-[140px] bg-[#0066AD] text-center border-r">Image</th>
                  <th className="w-[140px] bg-[#0066AD] text-center border-r">Model Name</th>
                  <th className="w-[140px] bg-[#0066AD] text-center border-r">Type</th>
                  <th className="w-[140px] bg-[#0066AD] text-center border-r">Chassis No</th>
                  <th className="w-[140px] bg-[#0066AD] text-center border-r">Engine No</th>
                  <th className="w-[140px] bg-[#0066AD] text-center border-r">Description</th>                 
                  <th className="w-[140px] bg-[#0066AD] text-center border-r">Price</th>
                  <th className="w-[140px] bg-[#0066AD] text-center border-r">Stock</th>
                  <th ><button
              className="bg-[#0066AD] text-white py-2 px-4 rounded hover:bg-[#023E8A] "
              onClick={handleOpen}
            >
              Add
            </button></th>
